...
console.log(totalA)
document.getElementById("Rs3").textContent=`${totalA.total + 20}`
...
function apply(){
    ...
    if(document.getElementById("code").value=="flat50"){
        document.getElementById("Rs3").textContent=`${(totalA.total + 20)/2}`
       // document.getElementById("Rs3").innerText= "Rs "+Math.floor(payableAmt/2) 
       let saving=document.getElementById("Rs4").textContent=`${(totalA.total + 20)/2}`
    }
}
