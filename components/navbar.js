function navbar(){
    ...
    <div class="three">
        <div class="location"><i class="fas fa-map-marker-alt"></i> <span>560004, Bangalore <i class="fas fa-angle-down"></i></span> <i class="far fa-user"></i><a href="" id ="loginbutton">Login/Sign Up</a></div>
